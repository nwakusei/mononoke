					...
					<div className="mb-4">
						...
						<div className="flex flex-row items-center gap-2">
							...
							<span className="mb-[2px]">
								Informações gerais: Esse tipo de frete é
								exclusivo do Melhor Envio, portanto leia todas
								as regras no site antes de configurar. ⇒{" "}
								<Link
						...
						<div className="flex flex-row items-center gap-2 -ml-[2px]">
							...
							<span>
								Pontos de Postagem: Confira os pontos de
								postagem mais próximos à você, no mapa do Melhor
								Envio. ⇒{" "}
								<Link
									className="text-secondary transition-all ease-in duration-200 hover:text-primary"
