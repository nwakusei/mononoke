// // Funciona mas o Build está quebrando por contas de elementos do Mercado Pago
...
function CheckoutCreditCardInstallmentsContent({
    ...
    () => ({
      visual: {
        ...
        texts: {
          ...
          emailSectionTitle: "Preencha seu e-mail",
          installmentsSectionTitle: "",
          cardholderName: { label: "", placeholder: "Nome e Sobrenome" },
          email: { label: "", placeholder: "" },
          cardholderIdentification: { label: "" },
          cardNumber: { label: "" },
      ...
      try {
        ...
        if (response.status === 201) {
          ...
          Swal.fire({
            ...
            width: 900,
            icon: "success",
            customClass: { confirmButton: "swal2-custom-confirm" },
          });
        ...
        Swal.fire({
          title: error.response?.data?.message || "Erro no pagamento",
          width: 900,
          icon: "error",
        });
      }
    },
    [products, shippingCost, coupons, router, setCart, setSubtotal]
  );
  ...
  const onReady = useCallback(async () => {
    // Pode ocultar carregamentos aqui, se quiser
  }, []);
  ...
  }, [initialization, onSubmit, onError, onReady]);
