    ...
    <section className="grid grid-cols-6 md:grid-cols-8 grid-rows-1 gap-4 mx-4 mt-4">
      <div className="bg-yellow-500 flex flex-row gap-8 col-start-2 col-span-4 md:col-start-2 md:col-span-6">
        ...
        <div className="flex flex-col">
          <div className="bg-base-100 w-[402px] rounded-md relative shadow-lg mb-2">
            <div className="h-[402px] flex items-center justify-center mx-3 my-2">
              <Image className="object-contain h-full" src={``} alt="Shoes" />
            </div>
          </div>
          {/* Pequenas imagens */}
        ...
        <div className="flex flex-col">
          ...
          {/* Preço */}
          <h2 className="text-2xl text-primary font-semibold">R$ {value}</h2>
          {/* Preço antes do desconto */}
          <div className="flex flex-row items-center mb-2">
            <span className="text-base line-through mr-2">R$ 109,90</span>
            <span className="bg-primary text-xs px-1 rounded-sm">20% Off</span>
          </div>
          {/* Cashback */}
          ...
          <div className="border rounded-lg mb-2">
            <div className="px-4 mb-2">
              ...
              <div className="flex flex-row justify-between items-center mb-2">
                ...
                <div className="text-sm">{stock} un disponíveis</div>
              </div>

              <div className="flex flex-row justify-between mb-2">
                <div className="font-semibold">Subtotal</div>
                <div className="font-semibold">{totalOrder}</div>
              </div>
          ...
          <div className="flex flex-col border border-solid p-2 rounded">
            <div className="mb-2">
              <h2 className="flex flex-row items-center gap-2 mb-2">
                <GrLocation size={18} />
                <span className="text-sm">Enviado de Joinville</span>
              </h2>
            ...
            >
              ...
              <div className="flex flex-row justify-between">
                <span className="text-sm">Previsão de envio</span>
          ...
          <div className="flex flex-row gap-4">
            ...
            <div className="flex flex-col">
              <div className="flex flex-row items-center gap-1 font-semibold text-lg">
                ...
                <MdVerified className="text-blue-700" size={18} />
              </div>
      ...
      <div className="bg-yellow-500 flex flex-col gap-8 col-start-2 col-span-4 md:col-start-2 md:col-span-6 mb-4">
        <div className="w-full border-opacity-50">
          <div className="flex flex-col">
            <div className="divider text-xl">Avaliações do Produto</div>
              ...
              <div className="flex flex-col">
                <div>
                  ...
                  <p className="text-base mb-2">
                    Ótimo produto. Chegou rápido e muito bem embalado,
                    recomendo!
                  </p>
                </div>
            ...
            <div className="flex flex-row gap-2">
              ...
              <div className="flex flex-col">
                <div>
                  {/* Avaliações e Vendidos */}
                  <h1 className="text-sm">Marina Penharver</h1>
                  <div className="flex flex-row items-center text-sm">
                    <span className="flex flex-row items-center gap-1">
                      <p className="mr-1 text-sm">5.0</p>
                      <BsStarFill size={12} />
