            ...
            rCategory.map((categoryProduct) => {
              ...
              return (
                <ProductAdCardOtamart
                  ...
                  originalPrice={Number(categoryProduct.originalPrice)}
                  promotionalPrice={Number(categoryProduct.promotionalPrice)}
                  price={Number(categoryProduct.originalPrice)}
                  promoPrice={Number(categoryProduct.promotionalPrice)}
                  cashback={cashback}
