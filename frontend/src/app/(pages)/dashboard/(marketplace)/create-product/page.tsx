  ...
  .object({
    productImages: z
      ...
      .refine(
        (files) => {
          return files.every(
            (file) => file === null || /\.(jpg|jpeg|png)$/i.test(file.name)
          );
        },
        {
          message: "※ Insira apenas imagens com extensão .JPG, .JPEG ou .PNG!",
        }
      ),
    productTitle: z
      .string()
            ...
            z.object({
              ...
              originalPrice: z
                ...
                .refine(
                  ...
                  {
                    message: "※ Insira um valor válido. Ex.: 0,00!",
                  }
                )
                .transform((value) =>
              ...
              imageUrl: z
                ...
                .refine(
                  ...
                  {
                    message: "O campo de imagem deve ser um arquivo de imagem.",
                  }
                )
                .transform((value) => {
                ...
                .refine(
                  (file) => file === null || file.size <= 2 * 1024 * 1024, // Verifica o tamanho
                  "O arquivo precisa ter no máximo 2MB!"
                )
                .refine(
                  (file) =>
                    file === null || /\.(jpg|jpeg|png)$/i.test(file.name), // Verifica a extensão
  ...
  .superRefine((data, ctx) => {
    ...
    productVariations.forEach((variation, variationIndex) => {
      ...
      options.forEach((option, optionIndex) => {
        ...
        if (!option.originalPrice || Number(option.originalPrice) <= 0) {
          ctx.addIssue({
            code: "custom",
            message: "※ O preço deve ser um número válido e maior que 0!",
            path: [
              "productVariations",
              variationIndex,
              "options",
        ...
        variations.forEach((variation, index) => {
          ...
          variation.options.forEach((option, optionIndex) => {
            ...
            const promotionalPrice =
              option.promotionalPrice && option.promotionalPrice !== ""
                ? parseFloat(option.promotionalPrice)
                : 0;

            formData.append(
              `productVariations[${index}][options][${optionIndex}][promotionalPrice]`,
              isNaN(promotionalPrice) ? "0" : promotionalPrice.toString()
            );
    ...
    <section className="bg-gray-300 grid grid-cols-6 md:grid-cols-10 grid-rows-1 gap-4">
      ...
      <div className="col-start-3 col-span-4 md:col-start-3 md:col-span-10 mb-4">
        <div className="flex flex-col gap-4 mb-8">
          <form onSubmit={handleSubmit(handleCreateProduct)} autoComplete="off">
            {/* Gadget 1 */}
                  ...
                  <label className="form-control">
                    ...
                    <input
                      ...
                      {...register("productTitle", {
                        onChange: () => trigger("productTitle"),
                      })}
                      onFocus={() => handleFocus("productTitle")}
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="form-control">
                      ...
                      >
                        ...
                        <option value="Game">Figure</option>
                        <option value="TCG">TCG (Card Game)</option>
                        ...
                        <option value="Keychain">Chaveiro</option>
                        ...
                        <option value="Figure">Game</option>
                        <option value="Backpack">Mochila</option>
                        <option value="Cushion">Almofada</option>
                    ...
                    <label className="form-control w-full max-w-3xl">
                      ...
                      <select
                        ...
                        {...register("adultProduct", {
                          onChange: () => trigger("adultProduct"),
                        })}
                        onFocus={() => handleFocus("adultProduct")}
                        onBlur={() => handleBlur("adultProduct")}
                      >
                        <option disabled value="">
                          Selecione uma opção
                        </option>
              ...
              <div className="flex flex-col gap-2 ml-6 mb-6">
                ...
                <div className="form-control">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    {selectedProductImages.map((imagem, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={(e) => {
                              e.preventDefault();
                              handleRemoveImageProduct(index);
                            }}
                          >
                            X
                          </button>
                    ...
                    <div
                      ...
                      onClick={() => {
                        const input =
                          document.getElementById("productImagesInput");
                        input?.click();
                      }}
                    >
                      <span className="text-xs">Add Imagem</span>
                      <AddPicture size={20} />
                    </div>
                    ...
                    <input
                      ...
                      onChange={handleSelectedProductImages}
                    />
                  </div>
            ...
            {displayVariations ? (
              <div className="bg-white w-[1200px] p-6 rounded-md mr-4 mb-4">
                <div className="flex flex-col text-black ml-6 mb-6 gap-2">
                  <h1 className="text-2xl font-semibold mb-3">Variações</h1>
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, value } }) => (
                      <>
                        {Array.isArray(value) &&
                          value.map((variation, variationIndex) => (
                            <div
                              className="flex flex-col gap-4"
                              key={variationIndex}
                            >
                              <h3>Variação {variationIndex + 1}</h3>
                              ...
                              <div className="flex flex-col">
                                ...
                                />
                                <div>
                                  {errors.productVariations?.[variationIndex]
                                    ?.title && (
                                    <span className="text-red-500 text-xs">
                                      {
                                        errors.productVariations?.[
                                          variationIndex
                                        ]?.title.message
                                      }
                                    </span>
                              ...
                              {variation.options.length > 0 && <h4>Opções</h4>}
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            const newVariations = Array.isArray(value)
                              ? [
                                  ...value,
                                  {
                                    title: "",
              ...
              <div className="bg-white w-[1200px] p-6 rounded-md mr-4 mb-4">
                <div className="flex flex-col gap-2 ml-6 mb-6">
                  ...
                  <div className="flex flex-row items-center">
                          ...
                          <div>
                            <input
                              ...
                              {...register("promotionalPrice", {
                                onChange: () => trigger("promotionalPrice"),
                              })}
                              onFocus={() => handleFocus("promotionalPrice")}
                              onBlur={() => handleBlur("promotionalPrice")}
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <label className="form-control w-full max-w-2xl">
                      <div className="label">
                        <span className="label-text text-black">Estoque</span>
                      </div>
                      <div className="join">
                        <div>
                          <div>
                  ...
                  <button
                    onClick={() => setDiisplayVariations(true)}
                ...
                <div className="flex flex-row">
                  ...
                  <label className="form-control w-full max-w-3xl">
                    ...
                    <select
                      ...
                      {...register("preOrder", {
                        onChange: () => trigger("preOrder"),
                      })}
                      onFocus={() => handleFocus("preOrder")}
                      onBlur={() => handleBlur("preOrder")}
                    >
                      <option disabled value="">
                        Selecione uma opção
                      </option>
                  ...
                  <label className="form-control w-full max-w-2xl">
                    <div className="label">
                      <span className="label-text text-black">
                        Você precisa de quantos dias para postar o produto?
                      </span>
                    </div>
                    <div className="join">
                      <div>
                        <div>
                          <input
                            ...
                            placeholder="0"
                            {...register("daysShipping", {
                              onChange: () => trigger("daysShipping"),
                            })}
                            onFocus={() => handleFocus("daysShipping")}
                            onBlur={() => handleBlur("daysShipping")}
                          />
                        </div>
                      </div>
                      <div className="indicator">
            ...
            <div className="bg-white w-[1200px] p-6 rounded-md mr-4 mb-4">
              <div className="flex flex-col gap-2 ml-6 mb-6">
                ...
                <div className="flex flex-row items-center">
                  ...
                  <label className="form-control w-full max-w-2xl">
                    <div className="label">
                      <span className="label-text text-black">Peso</span>
                    </div>
                    <div className="join">
                      <div>
                        <div>
                  ...
                  <label className="form-control w-full max-w-2xl">
                    <div className="label">
                      <span className="label-text text-black">Comprimento</span>
                    </div>
                    <div className="join">
                      <div>
                        <div>
                  ...
                  <label className="form-control w-full max-w-2xl ml-16">
                    <div className="label">
                      <span className="label-text text-black">Largura</span>
                    </div>
                    <div className="join">
                      <div>
                        <div>
                  ...
                  <label className="form-control w-full max-w-2xl ml-16">
                    <div className="label">
                      <span className="label-text text-black">Altura</span>
                    </div>
                    <div className="join">
                      <div>
                        <div>
                ...
                <div className="flex flex-row items-center">
                  <label className="form-control w-full max-w-2xl">
                    ...
                    <select
                      ...
                      onFocus={() => handleFocus("freeShipping")} // Mantém o foco
                      onBlur={() => handleBlur("freeShipping")} // Remove o foco
                    >
                  ...
                  <label className="form-control w-full max-w-2xl">
                    ...
                    <select
                      ...
                      disabled={offerFreeShipping === "false"} // Desabilita se "Não" for selecionado
                      defaultValue={
                        offerFreeShipping === "false" ? "Nenhuma" : ""
                      }
                      {...register("freeShippingRegion")}
                      onFocus={() => handleFocus("freeShippingRegion")}
                      onBlur={() => handleBlur("freeShippingRegion")}
                    >
                      <option value="" disabled>
                        Escolha a região
                      </option>
                    ...
                    <div className="label">
                      {errors.freeShippingRegion ? (
                        <span className="label-text-alt text-red-500">
                          {errors.freeShippingRegion.message}
                        </span>
                      ) : (
                        <span className="label-text-alt text-black opacity-0">
                          Label não visivel
                  ...
                  <label className="form-control w-full max-w-3xl">
                    ...
                    <select
                      ...
                      {...register("internationalShipping", {
                        onChange: () => trigger("internationalShipping"),
                      })}
                      onFocus={() => handleFocus("internationalShipping")}
                      onBlur={() => handleBlur("internationalShipping")}
                    >
                      <option value="" disabled>
                        Selecione uma opção
                      </option>
                    ...
                    <div className="label">
                      {errors.internationalShipping ? (
                        <span className="label-text-alt text-red-500">
                          {errors.internationalShipping.message}
                        </span>
                      ) : (
                        <span className="label-text-alt text-black opacity-0">
                          Label não visivel
