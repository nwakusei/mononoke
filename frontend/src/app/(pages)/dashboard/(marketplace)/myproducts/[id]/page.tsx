...
function MyProductPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await api.get(`/products/partner-product/${id}`, {
          headers: {
          ...
          <form onSubmit={handleSubmit(handleCreateProduct)}>
                ...
                <div className="flex flex-row gap-4">
                  ...
                  <label className="form-control">
                    ...
                    >
                      ...
                      <option value="TGC (Card Game)">TGC (Card Game)</option>
            ...
            <div className="bg-white w-[1200px] p-6 rounded-md mr-4 mb-4">
              ...
              <div className="flex flex-col gap-2 ml-6 mb-6">
                ...
                <label className="form-control w-full max-w-3xl">
                  ...
                  <div
                    className={`${
                      errors.imagesProduct && `border-error`
            ...
            <div className="bg-white w-[1200px] p-6 rounded-md mr-4 mb-4">
              <div className="flex flex-col gap-2 ml-6 mb-6">
                  ...
                  <div key={variation.id}>
                    <label className="form-control w-full max-w-3xl">
                      ...
                      <input
                        ...
                        onChange={(event) =>
                          handleNameChange(variation.id, event)
                        }
                      />
                      <div className="label">
                    ...
                    <div className="flex flex-row gap-2">
                      {variation.types &&
                        variation.types.map((type, index) => (
                          <label
                            key={index}
                          ...
                          >
                            ...
                            <input
                              ...
                              value={type}
                              onChange={(event) =>
                                handleTypeChange(variation.id, index, event)
                              }
                            />
                            <div className="label">
                              <span className="label-text-alt text-black">
                    ...
                    <div
                      ...
                      onClick={() => handleAddType(variation.id)}
                    >
                      <FaPlus size={16} />
                      <h2 className="text-base">Adicionar Opção</h2>
                    </div>
                  </div>
                ))}
                <div
                ...
                >
                  <FaPlus size={16} />
                  <h2 className="text-base">Adicionar Variação</h2>
                </div>
              </div>
            </div>
                    ...
                    <div className="join">
                      <div>
                        <div>
                          <input
                            className={`${
                              errors.daysShipping && `input-error`
                            } input input-bordered input-success join-item`}
                            placeholder="0"
                            defaultValue={product.daysShipping}
              ...
              <div className="flex flex-col gap-2 ml-6 mb-6">
                      ...
                      <div>
                        <div>
                          <input
                            ...
                            defaultValue={
                              product?.weight &&
                              product?.weight.toFixed(3).replace(".", ",")
                            }
                            {...register("weight")}
                          />
                        </div>
                ...
                <div className="flex flex-row items-center mb-6">
                  ...
                  <label className="form-control w-full max-w-2xl">
                    ...
                    <select
                      ...
                      disabled={offerFreeShipping === false}
                    >
                      <option value="" disabled>
                        Escolha a região
                      </option>
                      <option value="Nenhuma" disabled selected>
                        Nenhuma
                      </option>
                ...
                <div className="flex flex-row border-[1px] border-dashed border-sky-700 rounded p-4 gap-2">
                  <span className="flex items-center w-[130px] h-auto justify-center bg-yellow-500 rounded mr-4">
                    <CiWarning className="text-black" size={50} />
                  </span>
                  <p className="text-black">
                    Atenção: O pacote deverá ser postado em um ponto de coleta
                    da Kangu mesmo quando a etiqueta for dos Correios. Verifique
                    os pontos mais próximos do seu endereço no site da Kangu!
                    ...
                    <Link
                      ...
                      target="_blank"
                    >
                      <span>Pontos Kangu - Site Oficial</span>
