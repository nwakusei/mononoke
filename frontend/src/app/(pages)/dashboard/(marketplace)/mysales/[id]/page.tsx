            ...
            <div className="flex flex-col gap-2 ml-6 mb-6 text-black">
              ...
              <div className="overflow-x-auto">
                ...
                <table className="table mb-8">
                  ...
                  <thead>
                    <tr>
                      <th className="text-sm text-black">Subtotal do Pedido</th>
                            ...
                            <div>
                              {mysale?.itemsList
                                .reduce(
                                  (total, item) =>
                                    total +
                                    item.productPrice * item.productQuantity, // Multiplica pelo quantity
                                  0
                                )
                                .toLocaleString("pt-BR", {
                                  style: "currency",
                      ...
                      <td>
                        {Array.isArray(mysale?.itemsList) &&
                          mysale?.itemsList.length > 0 && (
                            <div>
                              {(() => {
                                const productTotal = mysale?.itemsList.reduce(
                                  (total, item) =>
                                    total +
                                ...
                                const decryptedCustomerOrderCostTotal = decrypt(
                    ...
                    <tr>
                      ...
                      <td>
                        {(() => {
                          ...
                          const decryptedPartnerCommissionOtamart = decrypt(
                            mysale?.partnerCommissionOtamart
                          );
                          ...
                          if (
                            decryptedCustomerOrderCostTotal === null ||
                            decryptedPartnerCommissionOtamart === null
                          ) {
