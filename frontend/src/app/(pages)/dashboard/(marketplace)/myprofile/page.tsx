...
const updateUserFormSchema = z
  .object({
    profileImage: z
      ...
      .refine(
        (file) => file === null || /\.(jpg|jpeg|png)$/i.test(file!.name), // Verifica se a extensão é JPG, JPEG ou PNG
    ...
    cpfCnpj: z
      ...
      .refine(
        (val) => {
          ...
          return val === undefined || val.length === 11 || val.length === 14;
        },
        {
          message: "※ O CNPJ deve ter 14 dígitos | O CPF deve ter 11 dígitos.",
        }
      ),
    description: z
      .string()
      ...
      .refine(
        ...
        {
          message: "※ A descrição precisa ter entre 100 e 150 caracteres!",
        }
      ),
    ...
    cashback: z
      ...
      .refine(
        (val) =>
          val === undefined || val === "" || Number.isInteger(Number(val)),
        {
  ...
  async function updateUser(data: TUpdateUserFormData) {
    ...
    Object.entries(sanitizedData).forEach(([key, value]) => {
      ...
      if (key === "profileImage" && value instanceof File) {
        ...
        console.log(`Adicionado ao FormData: ${key} - [Imagem de Perfil]`);
          ...
          >
              ...
              <div className="flex flex-col gap-2 ml-6 mb-6">
                ...
                <div className="flex flex-row gap-4">
                  ...
                  {user?.accountType === "partner" ? (
                    <label className="form-control w-full max-w-3xl">
                      <div className="label">
                        <span className="label-text text-black">CNPJ/CPF</span>
                      </div>
                      <input
                        type="text"
                        className={`input input-bordered ${getFieldClass(
                    ...
                    <label className="form-control w-full max-w-3xl">
                      <div className="label">
                        <span className="label-text text-black">CPF</span>
                      </div>
                      <input
                        type="text"
                        className={`input input-bordered ${getFieldClass(
                ...
                <div className="flex flex-row gap-4">
                  ...
                  <label className="form-control">
                    <div className="label">
                      <span className="label-text text-black">Nickname</span>
                    </div>
                    <input
                      type="text"
                      className={`input input-bordered ${getFieldClass(
                  ...
                  <label className="form-control w-full max-w-3xl">
                    ...
                    <select
                      ...
                      placeholder={`...`}
                      defaultValue={
                        user?.viewAdultContent !== undefined
                          ? String(user.viewAdultContent)
                          : ""
                      }
                      {...register("viewAdultContent", {
                        onChange: () => trigger("viewAdultContent"),
                      })}
                      onFocus={() => handleFocus("viewAdultContent")}
                      onBlur={() => handleBlur("viewAdultContent")}
                    >
                    ...
                    {errors.viewAdultContent && (
                      <div className="label">
                        <span className="label-text-alt text-red-500">
                          {errors.viewAdultContent.message}
                        </span>
                      </div>
                    )}
                  </label>
            ...
            <div className="bg-white w-[1200px] p-6 rounded-md shadow-md mr-4 mb-4">
              ...
              <div className="flex flex-col ml-6 mb-6 gap-2">
                <h1 className="text-2xl font-semibold text-black">Imagens</h1>
                    ...
                    >
                      {selectedProfileImage ? (
                        <>
                          ...
                          <button
                            ...
                            onClick={(e) => {
                              ...
                              setSelectedProfileImage(null); // Limpa a imagem renderizada
                            }}
                          >
                            X
                          </button>
                        ...
                        <div
                          ...
                          onChange={(event) =>
                            handleSelectedImage(event, setSelectedProfileImage)
                          }
                        >
                          <h2 className="text-xs mb-2">Add Imagem</h2>
                          <AddPicture size={20} />
                          <input
                            className="hidden"
                            type="file"
                    ...
                    <div className="label">
                      <span className="label-text-alt text-red-500">
                        {errors.profileImage ? (
                          ...
                          <span className="text-black">T. máx. 450x450p</span>
                        )}
                      </span>
                    </div>
                  </label>
                    ...
                    <>
                      <label className="form-control hidden">
                        ...
                        >
                          {selectedLogoImage ? (
                            ...
                            <div
                              className="flex flex-col justify-center items-center"
                              onChange={(event) =>
                                handleSelectedImage(event, setSelectedLogoImage)
                              }
                            >
                              <h2 className="text-xs mb-2">Add Imagem</h2>
                              <AddPicture size={20} />
                        ...
                        <div className="label">
                          <span className="label-text-alt text-red-500">
                            {errors.logoImage ? (
                              <span>{errors.logoImage.message}</span>
                            ) : (
                              <span className="text-black">
                                T. máx. 900x450p (mantenha a proporção para não
                                distorcer a imagem)
                              </span>
                            )}
                          </span>
                          ...
                          {selectedLogoImage ? (
                            <>
                              ...
                              <button
                                ...
                                onClick={(e) => {
                                  e.preventDefault(); // Previne o comportamento padrão
                                  setSelectedLogoImage(null); // Limpa a imagem renderizada
                                }}
                              >
                                X
                              </button>
                ...
                <div className="flex flex-row gap-4">
                  ...
                  <label className="form-control w-full max-w-3xl">
                    ...
                    <input
                      ...
                      placeholder={`...`}
                      defaultValue={user.address[0]?.neighborhood}
                      {...register("neighborhood", {
                        onChange: () => trigger("neighborhood"),
                      })}
                ...
                <div className="flex flex-row gap-4">
                  ...
                  <label className="form-control w-full max-w-3xl">
                    ...
                    <select
                      ...
                      value={
                        user.address && user.address[0]?.state
                    ...
                    >
                      <option disabled value="">
                        Em qual estado sua loja está localizada?
                      </option>
                  ...
                  <div className="flex flex-col gap-2 ml-6 mb-6">
                    ...
                    <label className="form-control w-[250px]">
                          ...
                          <div className="relative inline-block">
                            <div className="group">
                              ...
                              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-1 w-[880px] p-2 opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition duration-300 border-[1px] border-black bg-white text-black text-sm rounded shadow-lg pointer-events-none">
                                <p className="ml-2">
                                  Ao realizar uma venda você pagará 1,5x o
                                  Cashback oferecido, sendo valor dividido entre
                                  o cliente (x1) e a nossa plataforma (x0,5).
                                  Exemplo: Você oferece 2% de Cashback, portanto
                                  pagará 3% (2% para o cliente e 1% para nossa
                                  plataforma).
                                </p>
                              </div>
                            </div>
                      ...
                      <input
                        ...
                        {...register("cashback", {
                          onChange: () => trigger("cashback"),
                        })}
                        onFocus={() => handleFocus("cashback")}
                        onBlur={() => handleBlur("cashback")}
                      />
                      <div className="label">
                        <span className="label-text-alt text-red-500">
                          {errors.cashback && (
                            <span>{errors.cashback.message}</span>
                          )}
                        </span>
                      </div>
                    </label>
