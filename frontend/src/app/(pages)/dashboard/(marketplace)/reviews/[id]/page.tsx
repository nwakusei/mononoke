...
const createReviewFormSchema = z.object({
  imagesReview: z
    ...
    .refine(
      ...
      {
        message: "※ Insira apenas fotos com extensão .JPG, .JPEG ou .PNG!",
      }
    ),
  reviewRating: z
    .string()
        ...
        >
          ...
          <div className="bg-white text-black w-[1200px] p-6 rounded-md shadow-md mt-4">
            ...
            <div className="flex flex-col gap-2 mb-6">
              <h1 className="text-2xl font-semibold">Avalie o Pedido</h1>
            </div>
            <div className="mb-4">
                ...
                <table className="table">
                  ...
                  <thead>
                    <tr className="text-black">
                      <th className="text-base">Produto(s)</th>
            ...
            <div className="flex flex-row gap-16">
                  ...
                  <div className="flex flex-row items-center text-black gap-2">
                    ...
                    <input
                      className={`input input-bordered ${
                        errors.reviewRating ? `input-error` : `input-success`
              ...
              <div>
                <label>
                  <div className="mb-4">Descreva a avaliação:</div>
                </label>
                <textarea
                  ...
                  {...register("reviewDescription", {
                    onChange: () => trigger("reviewDescription"),
                  })}
                  onFocus={() => handleFocus("reviewDescription")}
                  onBlur={() => handleBlur("reviewDescription")}
                ></textarea>
                <div className="label">
          ...
          <div className="bg-white w-[1200px] p-6 rounded-md shadow-md mr-4 mb-4">
            <div className="flex flex-col gap-2 ml-6 mb-6">
              <h1 className="text-2xl font-semibold text-black">Fotos</h1>
              <label className="form-control w-full max-w-3xl">
                <div className="label">
                  <span className="label-text text-black">Foto Principal</span>
                </div>
                ...
                <div className="flex flex-wrap text-black gap-2">
                  {imagensSelecionadas.map((img, index) => (
                    <div
                      key={index}
                      className={`${
                        errors.imagesReview ? `border-error` : `border-success`
                  ...
                  {imagensSelecionadas.length < MAX_IMAGENS && (
                    <div
