...
import { BsCheck2, BsChatSquareText } from "react-icons/bs";
          ...
          >
            <div className="flex flex-row gap-4">
              ...
              <p className="text-base text-gray-700 mb-2">
                A funcionalidade de Chat ainda não está funcionando 100%,
                portanto talvez seja necessário intercalar entre os chats ou
                recarregar esta página para obter atualizações. Estamos
                trabalhando para melhorar essa e todas as outras funcionalidades
                para as próximas versões do site.
              </p>
            </div>
                ...
                <div className="flex flex-row items-center gap-2">
                  <div className="avatar online">
                    <div className="w-12 rounded-full">
                      {returnedChat.userTwoAccountType === "customer" ? (
                        <Image
              ...
              chats.map((chat) => (
                ...
                >
                  <div className="flex flex-row items-center gap-2">
                    <div className="avatar online">
                      <div className="w-12 rounded-full">
                        {chat.userTwoAccountType === "customer" ? (
                          <Image
                            className="object-contain w-[120px] pointer-events-none rounded shadow-md"
          ...
          <div>
              ...
              <div className="flex flex-row">
                <div className="flex flex-row items-center gap-2">
                  <div className="avatar online">
                    ...
                    ) : chat.userTwoAccountType === "partner" ? (
                      <div className="w-12 rounded-full">
                        <Image
                          className="object-contain w-[120px] pointer-events-none rounded shadow-md"
                          src={`https://mononokebucket.s3.us-east-1.amazonaws.com/${chat.userTwoProfileImage}`}
            ...
            >
              ...
              <form
                onSubmit={(e) => {
                  e.preventDefault();
                  handleSendMessage(chat.userTwoID, message, imageMessage);
                }}
