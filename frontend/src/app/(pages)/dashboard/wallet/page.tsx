                      ...
                      <div className="flex items-center gap-3">
                        <div className="avatar">
                          <div className="mask mask-squircle w-12 h-12">
                            <Image
                              src={`http://localhost:5000/customers/${transaction.payerProfileImage}`}
                    ...
                    <td>
                      ...
                      >
                        ...
                        (String(user?.otakupayID) ===
                          ...
                          ? "+ "
                          : "- "}
                        {decrypt(transaction.transactionValue)?.toLocaleString(
                          "pt-BR",
                          {
                            style: "currency",
                            currency: "BRL",
                          ...
                          <p className="flex flex-row items-center gap-2">
                            ...
                            <span>
                              {`Subtotal dos Produtos: ${decrypt(
                                transaction.transactionDetails.detailCost
                              )?.toLocaleString("pt-BR", {
                                style: "currency",
                                currency: "BRL",
                              })}`}
