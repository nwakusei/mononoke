...
const createProductFormSchema = z.object({
  ...
  productTitle: z
    ...
    .max(120, "※ O título do Produto precisa conter no máximo 120 caracteres!")
    .trim()
    .refine(
      (pName) => {
...
function CreateProductOtaclubPage() {
  ...
  async function handleCreateProductOtaclub(productData: {
    ...
    try {
      const response = await api.post("/products/otaclub-create", formData, {
        headers: {
