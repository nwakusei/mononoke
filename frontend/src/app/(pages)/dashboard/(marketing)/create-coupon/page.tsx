    ...
    <section className="bg-gray-300 grid grid-cols-6 md:grid-cols-10 grid-rows-1 gap-4">
      ...
      <div className="h-screen col-start-3 col-span-4 md:col-start-3 md:col-span-10 mb-4">
        <div className="flex flex-col gap-4 mb-8">
          <form onSubmit={handleSubmit(handleCreateCoupon)} autoComplete="off">
            {/* Gadget 1 */}
              ...
              <div className="flex flex-col gap-2 mb-6">
                ...
                <div className="flex flex-row items-center gap-4">
                  ...
                  <label className="form-control">
                    <div className="label">
                      <span className="label-text text-black">
                        Você deseja oferecer quantos % de desconto?
                      </span>
                    </div>
                    <div className="join">
                      <div>
                        <div>
                          <input
                            ...
                            {...register("discountPercentage", {
                              onChange: () => trigger("discountPercentage"),
                            })}
