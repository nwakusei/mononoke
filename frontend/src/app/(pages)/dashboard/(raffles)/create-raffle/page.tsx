...
function CreateRafflePage() {
  ...
  const handleSelectedImages = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  async function handleCreateRaffle(RaffleData: { [key: string]: any }) {
    ...
    try {
      const response = await api.post("/raffles/create-raffle", formData, {
        headers: {
          Authorization: `Bearer ${JSON.parse(token)}`,
        },
      });
    ...
    <section className="bg-gray-300 grid grid-cols-6 md:grid-cols-10 grid-rows-1 gap-4">
      ...
      <div className="col-start-3 col-span-4 md:col-start-3 md:col-span-10 mb-4">
        <div className="flex flex-col gap-4 mb-8">
          <form onSubmit={handleSubmit(handleCreateRaffle)} autoComplete="off">
            {/* Gadget 1 */}
              ...
              <div className="flex flex-col gap-2 mx-6 mb-6">
                ...
                <div className="flex flex-col gap-10">
                        ...
                        <div>
                          <div>
                            <input
                              ...
                              {...register("rafflePrize", {
                                onChange: () => trigger("rafflePrize"),
                              })}
                              onFocus={() => handleFocus("rafflePrize")}
                              onBlur={() => handleBlur("rafflePrize")}
                            />
                          </div>
                        </div>
                      </div>
                      <div className="label">
                        {errors.rafflePrize ? (
                          <span className="label-text-alt text-red-500">
                            {errors.rafflePrize.message}
                          </span>
                        ) : (
                          <span className="label-text-alt text-black">
                            Ex.: Figure Luffy - One Piece
                          </span>
                        )}
                      </div>
                    </label>
                        ...
                        <div>
                          <div>
                            <input
                              ...
                              placeholder={`dd/MM`}
                              {...register("raffleDate", {
                                onChange: () => trigger("raffleDate"),
                              })}
                              onFocus={() => handleFocus("raffleDate")}
                              onBlur={() => handleBlur("raffleDate")}
                            />
                          </div>
                        </div>
                        ...
                        <div>
                          <div>
                            <input
                              ...
                              placeholder="0"
                              {...register("raffleCost", {
                                onChange: () => trigger("raffleCost"),
                              })}
                              onFocus={() => handleFocus("raffleCost")}
                              onBlur={() => handleBlur("raffleCost")}
                            />
                          </div>
                        </div>
                        <div className="indicator">
                    ...
                    <label className="form-control">
                        ...
                        <div>
                          <div>
                            <input
                              ...
                              placeholder="0"
                              {...register("minNumberParticipants", {
                                onChange: () =>
                                  trigger("minNumberParticipants"),
                              })}
                              onFocus={() =>
                                handleFocus("minNumberParticipants")
                              }
                              onBlur={() => handleBlur("minNumberParticipants")}
                            />
                          </div>
                        </div>
                        <div className="indicator">
                      ...
                      <div className="label">
                        {errors.minNumberParticipants ? (
                          <span className="text-red-500 label-text-alt">
                            {errors.minNumberParticipants.message}
                          </span>
                        ) : (
                          <span className="label-text-alt text-black">
                            Ex: Informe o nº mínimo de participantes
                          </span>
                        )}
                      </div>
                    </label>
                  ...
                  <div className="flex flex-row items-center gap-8">
                    ...
                    <label className="form-control">
                      ...
                      <textarea
                        ...
                        {...register("raffleDescription", {
                          onChange: () => trigger("raffleDescription"),
                        })}
                        onFocus={() => handleFocus("raffleDescription")}
                    ...
                    <label className="form-control">
                      <div className="label">
                        <span className="label-text text-black">Regras</span>
                      </div>
                      <textarea
                        className={`textarea textarea-bordered ${getFieldClass(
                          "raffleRules",
                        ...
                        {...register("raffleRules", {
                          onChange: () => trigger("raffleRules"),
                        })}
                        onFocus={() => handleFocus("raffleRules")}
                        onBlur={() => handleBlur("raffleRules")}
                      ></textarea>

                      <div className="label">
                        {errors.raffleRules ? (
                          <span className="text-red-500 label-text-alt">
                            {errors.raffleRules.message}
                          </span>
                        ) : (
                          <span className="label-text-alt text-black">
                            Descreva as informações
                    ...
                    <label className="form-control w-[200px]">
                      ...
                      <select
                        ...
                        {...register("adultRaffle", {
                          onChange: () => trigger("adultRaffle"),
                        })}
                        onFocus={() => handleFocus("adultRaffle")}
                        onBlur={() => handleBlur("adultRaffle")}
                      >
                ...
                <div className="form-control">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div
                      ...
                      onClick={() => {
                        const input =
                          document.getElementById("imagesRaffleInput");
                        input?.click();
                      }}
                    >
