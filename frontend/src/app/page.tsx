          ...
          >
            <div>
              ...
              <p className="text-base text-white mb-2">
                Para melhor utilização, sugerimos que acesse nosso site
                prioritariamente via PC. Ainda estamos aplicando a
                responsividade, então você verá os elementos fora de lugar ao
                acessar via Smartphone.
              </p>
            </div>
        ...
        <div className="col-span-12 bg-white relative z-10">
          <div className="grid grid-cols-12">
            <div className="col-start-3 col-span-8 px-8 pt-8 pb-8 flex flex-row justify-center text-black relative">
              <div>
                <div className={`${poppins.className} text-4xl font-bold mb-4`}>
                  <div className="text-slate-800">
                    SEU <span className="text-primary">UNIVERSO OTAKU</span>{" "}
                    COMPLETO
                  </div>
                </div>
                <p className="text-xl text-slate-800">
                  Mononoke reúne vários benefícios voltados para os fãs de
                  anime, mangá, games e cultura pop japonesa em geral...
                </p>
              </div>
          ...
          <div className="flex flex-row justify-center flex-wrap gap-8 mb-4 max-w-[1200px]">
            <div className="flex flex-col justify-between p-4 w-[350px] h-[230px] bg-black opacity-80 rounded-md shadow-md transition-transform duration-300 hover:scale-110">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-white">
                  Compre os melhores produtos otaku diretamente de lojas
                  confiáveis, tudo em um só lugar.
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between p-4 w-[350px] h-[230px] bg-black opacity-80 rounded-md shadow-md transition-transform duration-300 hover:scale-110">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-white">
                  Ganhe parte do seu dinheiro de volta em todas as compras
            ...
            <div className="flex flex-col justify-between p-4 w-[350px] h-[230px] bg-black opacity-80 rounded-md shadow-md transition-transform duration-300 hover:scale-110">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-white">
                  Acumule pontos em todas as suas compras e troque por produtos
                  exclusivos.
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between p-4 w-[350px] h-[230px] bg-black opacity-80 rounded-md shadow-md transition-transform duration-300 hover:scale-110">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-white">
                  Acesso a promoções e descontos especiais disponíveis apenas
                  para clientes Mononoke.
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between p-4 w-[350px] h-[230px] bg-black opacity-80 rounded-md shadow-md transition-transform duration-300 hover:scale-110">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-white mb-6">
                  Participe de sorteios exclusivos com prêmios incríveis toda
                  semana.
                </span>
              </div>
            </div>
        ...
        <div className="bg-secondary flex flex-col justify-center items-center text-black col-start-0 col-span-8 px-8 pt-8 pb-16">
          ...
          >
            <div>
              ...
              <span className="text-black text-opacity-80">MONONOKE</span>?
            </div>{" "}
          </div>
          <p className="text-xl mb-8 text-white">
            Junte-se aos outros otakus que já estão aproveitando nossos
