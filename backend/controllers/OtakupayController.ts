	...
	static async releaseOfValuesOtaclub(req: Request, res: Response) {
		...
		try {
			...
			const newParterOtakuPointsAvailableDecrypted =
				...
				OtaclubProfitFromSaleDecrypted;
			...
			const decryptedTransactions = transactions.map((tx) => {
				...
				return {
					...
					transactionDetails: {
						...
						detailCost: decrypt(
							txObj.transactionDetails.detailCost
						),
						detailShippingCost: decrypt(
							txObj.transactionDetails.detailShippingCost
						),
						detailSalesFee: decrypt(
							txObj.transactionDetails.detailSalesFee
						),
						detailCashback: decrypt(
							txObj.transactionDetails.detailCashback
						),
					},
				};
			});
